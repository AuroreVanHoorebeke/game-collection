const collection = [
...

    {
        ...
        developer: 'EA Dice',
        category: ['FPS', 'Third Person Shooter'],
...

    {
        ...
        category: ['Action role-playing', 'FPS'],
...
for(let element of collection){
    ...
    cardImgFigure.className = "image is-4by3";
       ...
       // cardImg.className = element.image
    ...
    linkFooter.textContent = element.link;
    ...
    // columns.is-mobile.is-multiline.is-marginless.appendChild(columnDiv);
